        ...
        var ControlMultiUnitItemView = elementor.modules.controls.BaseMultiple.extend(
            {
                ui: function () {
                    ...
                    ui.controls = ".scp-control-multiunit > input:enabled";
                    ui.link = "button.scp-link-dimensions";
                    ui.top_choices =
                        "div.scp-units-choices > input[type=radio][data-setting=top_unit]";
                    ui.right_choices =
                        "div.scp-units-choices > input[type=radio][data-setting=right_unit]";
                    ui.bottom_choices =
                        "div.scp-units-choices > input[type=radio][data-setting=bottom_unit]";
                    ui.left_choices =
                        "div.scp-units-choices > input[type=radio][data-setting=left_unit]";
                    ui.unitLink = ".scp_link";
                    ui.gear = ".scp_link_first";
                    ui.ranges_top = ".scp-units-choices-label-top";
                    ui.ranges_right = ".scp-units-choices-label-right";
                    ui.ranges_bottom = ".scp-units-choices-label-bottom";
                    ui.ranges_left = ".scp-units-choices-label-left";
                    ui.linked = ".scp-linked";
                    ui.unlinked = ".scp-unlinked";
                    return ui;
                },
                ...
                setTopInputRange: function (event) {
                    ...
                    $(
                        "li.scp-control-multiunit > input[data-name=" +
                        this.name_control +
                        "-top]"
                ...
                TopRangeToggle: function (event) {
                    ...
                    if (this.range_top == false) {
                        $(".scp-units-choices-label-top[data-cat=" + cat + "]")
                            .not(event.target)
                            .hide();
                        this.range_top = true;
                    } else if (this.range_top == true) {
                        $(".scp-units-choices-label-top[data-cat=" + cat + "]").show();
                ...
                RightRangeToggle: function (event) {
                    ...
                    if (this.range_right == false) {
                        $(".scp-units-choices-label-right[data-cat=" + cat + "]")
                            .not(event.target)
                            .hide();
                        this.range_right = true;
                    } else if (this.range_right == true) {
                        $(".scp-units-choices-label-right[data-cat=" + cat + "]").show();
                ...
                BottomRangeToggle: function (event) {
                    ...
                    if (this.range_bottom == false) {
                        $("div.scp-units-choices > label[data-cat=" + cat + "]")
                            .not(event.target)
                            .hide();
                        this.range_bottom = true;
                    } else if (this.range_bottom == true) {
                        $(".scp-units-choices-label-bottom[data-cat=" + cat + "]").show();
                ...
                LeftRangeToggle: function (event) {
                    ...
                    if (this.range_left == false) {
                        $(".scp-units-choices-label-left[data-cat=" + cat + "]")
                            .not(event.target)
                            .hide();
                        this.range_left = true;
                    } else if (this.range_left == true) {
                        $(".scp-units-choices-label-left[data-cat=" + cat + "]").show();
                ...
                linkUnit: function (event) {
                    ...
                    $(
                        "div.scp-units-choices > input[type=radio][name=scp-choose-" +
                        this.name_control +
                        "-top][value=" +
                        "'" +
                        text +
                    ...
                    $(
                        ...
                        .prop("checked", true)
                        .trigger("change");
                    $("div.scp-units-choices > input[class=" + this.name_control + "]")
                        .not(":checked")
                        .next()
                        .hide();
                    $(
                        "div.scp-units-choices > input[class=" +
                        this.name_control +
                        "]:checked"
                    )
                        .next()
